...
//go:cgo_import_dynamic libc_dlopen_x dlopen "libdl.so"
//go:cgo_import_dynamic libc_dlclose_x dlclose "libdl.so"
//go:cgo_import_dynamic libc_dlsym_x dlsym "libdl.so"
//go:cgo_import_dynamic libc_dlerror_x dlerror "libdl.so"
